...
void gm_mpu6050_interface_initialize(void)
{
  ...
  /* External mode info */
  gm_mpu6050_interface_M->Sizes.checksums[0] = (3149502934U);
  gm_mpu6050_interface_M->Sizes.checksums[1] = (2517247432U);
  gm_mpu6050_interface_M->Sizes.checksums[2] = (2116825607U);
  gm_mpu6050_interface_M->Sizes.checksums[3] = (482258444U);
