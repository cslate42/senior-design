###########################################################################
## Makefile generated for Simulink model 'motor_controller'. 
## 
## Makefile     : motor_controller.mk
## Generated on : Tue Nov 07 15:25:37 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/motor_controller.exe
...
MODELREF_LINK_RSPFILE_NAME = motor_controller_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = motor_controller_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motor_controller.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/motor_controller_grt_rtw -I$(START_DIR)/motor-controller -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=motor_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/motor_controller_grt_rtw/motor_controller.c $(START_DIR)/motor_controller_grt_rtw/motor_controller_data.c $(START_DIR)/motor_controller_grt_rtw/rtGetInf.c $(START_DIR)/motor_controller_grt_rtw/rtGetNaN.c $(START_DIR)/motor_controller_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = motor_controller.obj motor_controller_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/motor_controller_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/motor_controller_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
