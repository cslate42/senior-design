...
static void c1_cfgDone1(SFc1_mpu6050InstanceStruct *chartInstance);
   ...
   case c1_IN_idle:
    ...
    if (c1_c_out) {
      ...
      *chartInstance->c1_tmpReadDevice = true;
      ...
      if (c1_temp) {
        c1_b_temp = (_SFD_CCP_CALL(1U, 1, CV_RELATIONAL_EVAL(5U, 1U, 1, (real_T)*
          ...
          *chartInstance->c1_configDevice) != 0U, *chartInstance->c1_sfEvent) !=
                     0U);
        if (!c1_b_temp) {
          c1_b_temp = (_SFD_CCP_CALL(1U, 2, CV_RELATIONAL_EVAL(5U, 1U, 2,
            (real_T)*chartInstance->c1_selfInit, 1.0, 0, 0U, (int32_T)
            *chartInstance->c1_selfInit) != 0U, *chartInstance->c1_sfEvent) !=
                       0U);
        }
      ...
      c1_d_out = (CV_TRANSITION_EVAL(1U, (int32_T)c1_temp) != 0);
      if (c1_d_out) {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_data_out = 1U;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 59U,
                 *chartInstance->c1_sfEvent);
    c1_temp = (_SFD_CCP_CALL(59U, 0, CV_RELATIONAL_EVAL(5U, 59U, 0, 1.0, 0.0, 0,
      0U, 0) != 0U, *chartInstance->c1_sfEvent) != 0U);
    if (c1_temp) {
      c1_temp = (_SFD_CCP_CALL(59U, 1, CV_RELATIONAL_EVAL(5U, 59U, 1, (real_T)
        *chartInstance->c1_n_ack, 1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack)
                  != 0U, *chartInstance->c1_sfEvent) != 0U);
    }

    c1_b_out = (CV_TRANSITION_EVAL(59U, (int32_T)c1_temp) != 0);
    if (c1_b_out) {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_tmp = true;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 65U,
                 *chartInstance->c1_sfEvent);
    c1_temp = (_SFD_CCP_CALL(65U, 0, CV_RELATIONAL_EVAL(5U, 65U, 0, 1.0, 0.0, 0,
      0U, 0) != 0U, *chartInstance->c1_sfEvent) != 0U);
    if (c1_temp) {
      c1_temp = (_SFD_CCP_CALL(65U, 1, CV_RELATIONAL_EVAL(5U, 65U, 1, (real_T)
        *chartInstance->c1_n_ack, 1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack)
                  != 0U, *chartInstance->c1_sfEvent) != 0U);
    }

    c1_b_out = (CV_TRANSITION_EVAL(65U, (int32_T)c1_temp) != 0);
    if (c1_b_out) {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_data_out = 0U;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 63U,
                 *chartInstance->c1_sfEvent);
    c1_temp = (_SFD_CCP_CALL(63U, 0, CV_RELATIONAL_EVAL(5U, 63U, 0, 1.0, 0.0, 0,
      0U, 0) != 0U, *chartInstance->c1_sfEvent) != 0U);
    if (c1_temp) {
      c1_temp = (_SFD_CCP_CALL(63U, 1, CV_RELATIONAL_EVAL(5U, 63U, 1, (real_T)
        *chartInstance->c1_n_ack, 1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack)
                  != 0U, *chartInstance->c1_sfEvent) != 0U);
    }

    c1_b_out = (CV_TRANSITION_EVAL(63U, (int32_T)c1_temp) != 0);
    if (c1_b_out) {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_data_out = 0U;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 62U,
                 *chartInstance->c1_sfEvent);
    c1_temp = (_SFD_CCP_CALL(62U, 0, CV_RELATIONAL_EVAL(5U, 62U, 0, 1.0, 0.0, 0,
      0U, 0) != 0U, *chartInstance->c1_sfEvent) != 0U);
    if (c1_temp) {
      c1_temp = (_SFD_CCP_CALL(62U, 1, CV_RELATIONAL_EVAL(5U, 62U, 1, (real_T)
        *chartInstance->c1_n_ack, 1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack)
                  != 0U, *chartInstance->c1_sfEvent) != 0U);
    }

    c1_b_out = (CV_TRANSITION_EVAL(62U, (int32_T)c1_temp) != 0);
    if (c1_b_out) {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_data_out = 0U;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 64U,
                 *chartInstance->c1_sfEvent);
    c1_temp = (_SFD_CCP_CALL(64U, 0, CV_RELATIONAL_EVAL(5U, 64U, 0, 1.0, 0.0, 0,
      0U, 0) != 0U, *chartInstance->c1_sfEvent) != 0U);
    if (c1_temp) {
      c1_temp = (_SFD_CCP_CALL(64U, 1, CV_RELATIONAL_EVAL(5U, 64U, 1, (real_T)
        *chartInstance->c1_n_ack, 1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack)
                  != 0U, *chartInstance->c1_sfEvent) != 0U);
    }

    c1_b_out = (CV_TRANSITION_EVAL(64U, (int32_T)c1_temp) != 0);
    if (c1_b_out) {
  ...
  uint8_T c1_msb, uint8_T c1_lsb)
{
  ...
  int16_T c1_c_a;
  int16_T c1_b;
  _SFD_DATA_RANGE_CHECK((real_T)c1_lsb, 36U, 4U, 49U, *chartInstance->c1_sfEvent,
                        false);
  _SFD_DATA_RANGE_CHECK((real_T)c1_msb, 35U, 4U, 49U, *chartInstance->c1_sfEvent,
                        false);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)c1_val, 37U, 4U, 49U, *chartInstance->c1_sfEvent,
                        false);
  _SFD_EML_CALL(49U, *chartInstance->c1_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2653367776U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1167410714U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2486385557U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3549522136U);
}
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static unsigned int sEndGuardMap[] = { 6, 18 };

          static int sPostFixPredicateTree[] = { 0, 1, -3 };

          _SFD_CV_INIT_TRANS(59,2,&(sStartGuardMap[0]),&(sEndGuardMap[0]),3,
                             &(sPostFixPredicateTree[0]));
        }

        {
          static unsigned int sStartRelationalopMap[] = { 2, 10 };

          static unsigned int sEndRelationalopMap[] = { 6, 18 };
...

        {
          ...
          _SFD_CV_INIT_TRANSITION_RELATIONALOP(62,2,&(sStartRelationalopMap[0]),
            &(sEndRelationalopMap[0]),&(sRelationalopEps[0]),
            &(sRelationalopType[0]));
        }
...
{
  return "s2wbkRmAtXL0M4KkVoPCD4C";
}
...
static void mdlSetWorkWidths_c1_mpu6050(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3677376302U));
  ssSetChecksum1(S,(747990860U));
  ssSetChecksum2(S,(1852999824U));
  ssSetChecksum3(S,(3998220151U));
