...
uint32_T _mpu6050MachineNumber_;

/* Function Declarations */

/* Function Definitions */
void mpu6050_initializer(void)
{
}

void mpu6050_terminator(void)
{
}
  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==5) {
    c5_mpu6050_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (!strcmp(machineName, "mpu6050")) {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        extern mxArray *sf_c5_mpu6050_get_testpoint_info(void);
        plhs[0] = sf_c5_mpu6050_get_testpoint_info();
        break;
      }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(818915567U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2383220938U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(510181767U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4042539574U);
       ...
       case 5:
        {
          ...
          sf_c5_mpu6050_get_check_sum(plhs);
          break;
        }
...
unsigned int sf_mpu6050_autoinheritance_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        if (strcmp(aiChksum, "s71fEcbgkKWZZLPdO7BTU") == 0) {
          extern mxArray *sf_c5_mpu6050_get_autoinheritance_info(void);
          plhs[0] = sf_c5_mpu6050_get_autoinheritance_info();
          break;
        }
...
unsigned int sf_mpu6050_get_eml_resolved_functions_info( int nlhs, mxArray *
     ...
     case 5:
      {
        ...
        mxArray *persistentMxArray = (mxArray *)
          sf_c5_mpu6050_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
unsigned int sf_mpu6050_third_party_uses_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        if (strcmp(tpChksum, "sf85NVBVLbAIgvYg2cdFqpD") == 0) {
          extern mxArray *sf_c5_mpu6050_third_party_uses_info(void);
          plhs[0] = sf_c5_mpu6050_third_party_uses_info();
          break;
        }
      }
...
unsigned int sf_mpu6050_jit_fallback_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        if (strcmp(tpChksum, "sf85NVBVLbAIgvYg2cdFqpD") == 0) {
          extern mxArray *sf_c5_mpu6050_jit_fallback_info(void);
          plhs[0] = sf_c5_mpu6050_jit_fallback_info();
          break;
        }
      }
...
unsigned int sf_mpu6050_updateBuildInfo_args_info( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        if (strcmp(tpChksum, "sf85NVBVLbAIgvYg2cdFqpD") == 0) {
          extern mxArray *sf_c5_mpu6050_updateBuildInfo_args_info(void);
          plhs[0] = sf_c5_mpu6050_updateBuildInfo_args_info();
          break;
        }
      }
...
void mpu6050_register_exported_symbols(SimStruct* S)
{
}
...
void unload_mpu6050_optimization_info(void);
mxArray* load_mpu6050_optimization_info(boolean_T isRtwGen, boolean_T isModelRef,
  boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info("mpu6050",
      "mpu6050");
