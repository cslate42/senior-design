...
static void initialize_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void initialize_params_c4_mpu6050(SFc4_mpu6050InstanceStruct
  *chartInstance);
static void enable_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void disable_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_mpu6050(SFc4_mpu6050InstanceStruct
  *chartInstance);
static void ext_mode_exec_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_mpu6050(SFc4_mpu6050InstanceStruct
  *chartInstance);
static void set_sim_state_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_mpu6050(SFc4_mpu6050InstanceStruct *
  chartInstance);
static void finalize_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void sf_gateway_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void mdl_start_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_chartstep_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void initSimStructsc4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_init(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_idle(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_start(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_NACK(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_getaddr(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_endgetaddr(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_sendack(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_enter_atomic_senddatastart(SFc4_mpu6050InstanceStruct
  *chartInstance);
static void c4_senddatastart(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_getdatastart(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_sendbyte(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_getdata(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_sendbit(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_endgetdata(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_lookRestart(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_getcfgregstart(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_sendAck(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_enter_atomic_getcfgdata(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_getcfgdata(SFc4_mpu6050InstanceStruct *chartInstance);
static void c4_error(SFc4_mpu6050InstanceStruct *chartInstance, int32_T
                     c4_varargin_1);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_b_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_reg, const char_T *c4_identifier);
static uint8_T c4_c_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static boolean_T c4_d_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_sf_internal_predicateOutput, const char_T *c4_identifier);
static boolean_T c4_e_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_f_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_g_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_b_addr, const char_T *c4_identifier);
static uint8_T c4_h_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_i_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_b_data, const char_T *c4_identifier);
static uint8_T c4_j_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_k_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_b_dataWrittenToVector, const char_T *c4_identifier,
  boolean_T c4_y[8]);
static void c4_l_emlrt_marshallIn(SFc4_mpu6050InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, boolean_T c4_y[8]);
static const mxArray *c4_m_emlrt_marshallIn(SFc4_mpu6050InstanceStruct
  *chartInstance, const mxArray *c4_b_setSimStateSideEffectsInfo, const char_T
  *c4_identifier);
static const mxArray *c4_n_emlrt_marshallIn(SFc4_mpu6050InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc4_mpu6050InstanceStruct
  *chartInstance, int32_T c4_ssid);
static void c4_init_sf_message_store_memory(SFc4_mpu6050InstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc4_mpu6050InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_mpu6050InstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc4_mpu6050(chartInstance);
  ...
  *chartInstance->c4_is_active_c4_mpu6050 = 0U;
  *chartInstance->c4_is_c4_mpu6050 = c4_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c4_is_c4_mpu6050 == c4_IN_getcfgdata) {
...
static void ext_mode_exec_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance)
{
  c4_update_debugger_state_c4_mpu6050(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c4_h_hoistedGlobal = *chartInstance->c4_is_active_c4_mpu6050;
  c4_k_y = NULL;
  sf_mex_assign(&c4_k_y, sf_mex_create("y", &c4_h_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c4_y, 7, c4_k_y);
  c4_i_hoistedGlobal = *chartInstance->c4_is_c4_mpu6050;
  c4_l_y = NULL;
  ...
  const mxArray *c4_st)
{
  ...
  *chartInstance->c4_is_active_c4_mpu6050 = c4_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c4_mpu6050", c4_u, 7)),
    "is_active_c4_mpu6050");
  *chartInstance->c4_is_c4_mpu6050 = c4_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c4_mpu6050", c4_u, 8)), "is_c4_mpu6050");
...
static void sf_gateway_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance)
{
  c4_set_sim_state_side_effects_c4_mpu6050(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c4_sda, 6U, 1U, 0U,
                        *chartInstance->c4_sfEvent, false);
  *chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_mpu6050(chartInstance);
...
static void c4_chartstep_c4_mpu6050(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c4_is_active_c4_mpu6050 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_active_c4_mpu6050 = 1U;
    ...
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c4_sfEvent);
    ...
    *chartInstance->c4_reg_idx = 0U;
    ...
    switch (*chartInstance->c4_is_c4_mpu6050) {
     case c4_IN_NACK:
      CV_CHART_EVAL(2, 0, 1);
     ...
     case c4_IN_startgetaddr:
      ...
      if (c4_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 18U, *chartInstance->c4_sfEvent);
        *chartInstance->c4_is_c4_mpu6050 = c4_IN_getaddr;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c4_sfEvent);
     ...
     case c4_IN_waitEndOfAck:
      ...
      if (c4_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 19U, *chartInstance->c4_sfEvent);
        *chartInstance->c4_is_c4_mpu6050 = c4_IN_waitForStop;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c4_sfEvent);
      } else {
     ...
     case c4_IN_waitForStop:
      ...
      if (c4_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c4_sfEvent);
        *chartInstance->c4_is_c4_mpu6050 = c4_IN_idle;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c4_sfEvent);
     ...
     case c4_IN_waitforPos:
      ...
      if (c4_d_out) {
        ...
        *chartInstance->c4_data = 0U;
        ...
        _SFD_SYMBOL_SCOPE_POP();
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c4_sfEvent);
        *chartInstance->c4_is_c4_mpu6050 = c4_IN_getcfgdata;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c4_sfEvent);
        ...
        if (c4_f_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c4_sfEvent);
          *chartInstance->c4_is_c4_mpu6050 = c4_IN_lookRestart;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c4_sfEvent);
        } else {
        ...
        *chartInstance->c4_is_c4_mpu6050 = c4_IN_waitForStop;
        ...
        if (c4_g_out) {
          ...
          *chartInstance->c4_rd_cnt = (uint8_T)c4_u3;
          ...
          _SFD_SYMBOL_SCOPE_POP();
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 22U, *chartInstance->c4_sfEvent);
          *chartInstance->c4_is_c4_mpu6050 = c4_IN_senddatastart;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 15U, *chartInstance->c4_sfEvent);
...
static void c4_idle(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_start;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 17U, *chartInstance->c4_sfEvent);
...
static void c4_start(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 17U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_startgetaddr;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 18U, *chartInstance->c4_sfEvent);
  } else {
  ...
  if (c4_out) {
    ...
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_startgetaddr;
    ...
    if (c4_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c4_sfEvent);
      *chartInstance->c4_is_c4_mpu6050 = c4_IN_endgetaddr;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c4_sfEvent);
...
static void c4_endgetaddr(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_NACK;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c4_sfEvent);
    ...
    *chartInstance->c4_sda_out = true;
    ...
    if (c4_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c4_sfEvent);
      *chartInstance->c4_is_c4_mpu6050 = c4_IN_sendack;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, *chartInstance->c4_sfEvent);
    ...
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_senddatastart;
    ...
    if (c4_b_out) {
      ...
      *chartInstance->c4_rd_cnt = 0U;
      ...
      _SFD_SYMBOL_SCOPE_POP();
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 12U, *chartInstance->c4_sfEvent);
      *chartInstance->c4_is_c4_mpu6050 = c4_IN_getdatastart;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, *chartInstance->c4_sfEvent);
    } else {
...
static void c4_senddatastart(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 15U, *chartInstance->c4_sfEvent);
  *chartInstance->c4_is_c4_mpu6050 = c4_IN_sendbyte;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, *chartInstance->c4_sfEvent);
...
static void c4_getdatastart(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_getdata;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c4_sfEvent);
...
static void c4_sendbyte(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 14U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_sendbit;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, *chartInstance->c4_sfEvent);
  ...
  if (c4_out) {
    ...
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_getdatastart;
    ...
    if (c4_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c4_sfEvent);
      *chartInstance->c4_is_c4_mpu6050 = c4_IN_endgetdata;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c4_sfEvent);
  ...
  if (c4_out) {
    ...
    *chartInstance->c4_sda_out = (c4_c != 0);
    ...
    if (c4_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, *chartInstance->c4_sfEvent);
      *chartInstance->c4_is_c4_mpu6050 = c4_IN_waitstop1;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 22U, *chartInstance->c4_sfEvent);
    } else {
...
static void c4_endgetdata(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_waitforPos;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c4_sfEvent);
  } else {
...
static void c4_sendAck(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_waitEndOfAck;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c4_sfEvent);
  } else {
...
static void c4_getcfgdata(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c4_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c4_sfEvent);
    *chartInstance->c4_is_c4_mpu6050 = c4_IN_getcfgregstart;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c4_sfEvent);
  } else {
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u;
  const mxArray *c4_y = NULL;
  SFc4_mpu6050InstanceStruct *chartInstance;
  chartInstance = (SFc4_mpu6050InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_mpu6050_get_eml_resolved_functions_info(void)
{
...
static void init_simulink_io_address(SFc4_mpu6050InstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_mpu6050 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c4_is_c4_mpu6050 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c4_mpu6050_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_mpu6050_get_post_codegen_info(void);
mxArray *sf_c4_mpu6050_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_mpu6050_get_post_codegen_info();
...
mxArray *sf_c4_mpu6050_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_mpu6050_jit_fallback_info(void)
{
...
mxArray *sf_c4_mpu6050_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_mpu6050(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[3],T\"sda_out\",},{M[3],M[15],T\"addr\",},{M[3],M[16],T\"bit_idx\",},{M[3],M[31],T\"data\",},{M[3],M[123],T\"rd_cnt\",},{M[3],M[78],T\"reg_idx\",},{M[3],M[37],T\"rw\",},{M[8],M[0],T\"is_active_c4_mpu6050\",},{M[9],M[0],T\"is_c4_mpu6050\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_mpu6050_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc4_mpu6050InstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_mpu6050InstanceStruct *chartInstance = (SFc4_mpu6050InstanceStruct *)
...
static void sf_opaque_initialize_c4_mpu6050(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc4_mpu6050InstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc4_mpu6050InstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
  initialize_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_mpu6050(void *chartInstanceVar)
{
  enable_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_mpu6050(void *chartInstanceVar)
{
  disable_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_mpu6050(void *chartInstanceVar)
{
  sf_gateway_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c4_mpu6050(void *chartInstanceVar)
{
  ext_mode_exec_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_mpu6050(SimStruct* S)
{
  return get_sim_state_c4_mpu6050((SFc4_mpu6050InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_mpu6050(SimStruct* S, const mxArray *st)
{
  set_sim_state_c4_mpu6050((SFc4_mpu6050InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c4_mpu6050(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_mpu6050InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_mpu6050_optimization_info();
    }

    finalize_c4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_mpu6050((SFc4_mpu6050InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_mpu6050(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_mpu6050((SFc4_mpu6050InstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

mxArray *sf_c4_mpu6050_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x2'varName','path'{{T\"is_active_c4_mpu6050\",T\"is_active_c4_mpu6050\"},{T\"is_c4_mpu6050\",T\"is_c4_mpu6050\"}}"
  };
...
static void mdlSetWorkWidths_c4_mpu6050(SimStruct *S)
{
...
static void mdlRTW_c4_mpu6050(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_mpu6050(SimStruct *S)
{
  SFc4_mpu6050InstanceStruct *chartInstance;
  chartInstance = (SFc4_mpu6050InstanceStruct *)utMalloc(sizeof
    (SFc4_mpu6050InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc4_mpu6050InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_mpu6050;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_mpu6050;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_mpu6050;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_mpu6050;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_mpu6050;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_mpu6050;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_mpu6050;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_mpu6050;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_mpu6050;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_mpu6050;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_mpu6050;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c4_mpu6050;
  ...
  mdl_start_c4_mpu6050(chartInstance);
}

void c4_mpu6050_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_mpu6050(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_mpu6050(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_mpu6050(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_mpu6050_method_dispatcher.\n"
