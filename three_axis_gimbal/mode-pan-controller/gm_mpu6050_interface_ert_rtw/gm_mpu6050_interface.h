...
typedef struct {
  ...
  zynq_AXIRead_gm_mpu6050_inter_T obj_h;/* '<S11>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_g;/* '<S10>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_l;/* '<S9>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_c;/* '<S8>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_i;/* '<S7>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_ga;/* '<S6>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_f;/* '<S5>/AXI4-Interface Read' */
  zynq_AXIRead_gm_mpu6050_inter_T obj_n;/* '<S4>/AXI4-Interface Read' */
  zynq_AXIWrite_gm_mpu6050_inte_T obj_p;/* '<S14>/AXI4-Interface Write' */
  zynq_AXIWrite_gm_mpu6050_inte_T obj_f4;/* '<S13>/AXI4-Interface Write' */
  struct {
    void *LoggedData[2];
  ...
  void *AXI4InterfaceWrite_PWORK_o;    /* '<S13>/AXI4-Interface Write' */
  void *AXI4InterfaceRead_PWORK;       /* '<S12>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_h;     /* '<S11>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_p;     /* '<S10>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_i;     /* '<S9>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_n;     /* '<S8>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_o;     /* '<S7>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_m;     /* '<S6>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_ns;    /* '<S5>/AXI4-Interface Read' */
  void *AXI4InterfaceRead_PWORK_j;     /* '<S4>/AXI4-Interface Read' */
