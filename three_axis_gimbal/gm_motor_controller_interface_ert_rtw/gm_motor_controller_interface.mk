###########################################################################
## Makefile generated for Simulink model 'gm_motor_controller_interface'. 
## 
## Makefile     : gm_motor_controller_interface.mk
## Generated on : Tue Nov 07 15:26:34 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gm_motor_controller_interface
...
PRODUCT_NAME              = gm_motor_controller_interface
MAKEFILE                  = gm_motor_controller_interface.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = gm_motor_controller_interface_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gm_motor_controller_interface
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/gm_motor_controller_interface_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/ProgramData/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/zynq/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=gm_motor_controller_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=gm_motor_controller_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/gm_motor_controller_interface_ert_rtw/gm_motor_controller_interface.c C:/ProgramData/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/zynq/src/axi4Lite.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/gm_motor_controller_interface_ert_rtw/ert_main.c
...
OBJS = gm_motor_controller_interface.c.o axi4Lite.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/gm_motor_controller_interface_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/gm_motor_controller_interface_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/gm_motor_controller_interface_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
axi4Lite.c.o : C:/ProgramData/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/zynq/src/axi4Lite.c
	$(CC) $(CFLAGS) -o $@ $<
