...
#include "mpu6050_driver_sfun.h"
#include "c1_mpu6050_driver.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "mpu6050_driver_sfun_debug_macros.h"
...
static void initialize_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void initialize_params_c1_mpu6050_driver
  (SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void enable_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void disable_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_mpu6050_driver
  (SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void ext_mode_exec_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_mpu6050_driver
  (SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void set_sim_state_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_mpu6050_driver
  (SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void finalize_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void sf_gateway_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void mdl_start_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void initSimStructsc1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_setupReadWhoAmI(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy0(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readWhoAmI1(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadPwrMgmt1(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_waitforNotBusy1(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readPwrManagement1(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_setupWritePwrMgmt1(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_waitforNotBusy2(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_cfgDone(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_getDEVID(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_b_waitforNotBusy1(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_readDEVID(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_debuggingState(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_getRegData(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy5(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readUserRegData(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_Valid(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadGyroZoutH(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_readGyroXoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy01(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readGyroYoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy06(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readGyroYoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy04(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readGyroZoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy03(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy05(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadGyroXoutL(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_readGyroZoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadGyroYoutH(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_setupReadGyroXoutH(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_waitforNotBusya6(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readAccelZoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadAccelXoutH(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_waitforNotBusya7(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readAccelXoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusya3(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readAccelYoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readAccelXoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadAccelYoutH(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_setupReadAccelZoutL(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_setupReadAccelZoutH(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_waitforNotBusya5(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusya1(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusya4(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadAccelYoutL(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_readAccelZoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadAccelXoutL(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_b_readGyroYoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_waitforNotBusy07(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_readGyroXoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupReadGyroYoutL(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void c1_waitforNotBusy3(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void c1_setupFS_SEL(SFc1_mpu6050_driverInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int16_T c1_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_val, const char_T *c1_identifier);
static int16_T c1_b_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_c_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_lsb, const char_T *c1_identifier);
static uint8_T c1_d_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_e_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static int16_T c1_convert_int16(SFc1_mpu6050_driverInstanceStruct *chartInstance,
  uint8_T c1_msb, uint8_T c1_lsb);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_g_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_b_enb, const char_T *c1_identifier);
static boolean_T c1_h_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint32_T c1_i_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_b_cnt, const char_T *c1_identifier);
static uint32_T c1_j_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_k_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_l_emlrt_marshallIn(SFc1_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc1_mpu6050_driverInstanceStruct *chartInstance, int32_T c1_ssid);
static void c1_init_sf_message_store_memory(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_mpu6050_driverInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_mpu6050_driver(chartInstance);
  ...
  *chartInstance->c1_is_active_c1_mpu6050_driver = 0U;
  *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance->c1_is_active_c1_mpu6050_driver = 1U;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
  _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
  *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_init;
  ...
  *chartInstance->c1_slv_addr = chartInstance->c1_SlvAddr;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_slv_addr, 13U, 4U, 62U,
                        *chartInstance->c1_sfEvent, false);
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_mpu6050_driverMachineNumber_,
...
static void ext_mode_exec_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance)
{
  c1_update_debugger_state_c1_mpu6050_driver(chartInstance);
}
  ...
  (SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  c1_t_hoistedGlobal = *chartInstance->c1_is_active_c1_mpu6050_driver;
  c1_u_y = NULL;
  sf_mex_assign(&c1_u_y, sf_mex_create("y", &c1_t_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 19, c1_u_y);
  c1_u_hoistedGlobal = *chartInstance->c1_is_c1_mpu6050_driver;
  c1_v_y = NULL;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *chartInstance->c1_is_active_c1_mpu6050_driver = c1_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c1_mpu6050_driver",
       c1_u, 19)), "is_active_c1_mpu6050_driver");
  *chartInstance->c1_is_c1_mpu6050_driver = c1_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c1_mpu6050_driver", c1_u, 20)),
    "is_c1_mpu6050_driver");
...
static void sf_gateway_c1_mpu6050_driver(SFc1_mpu6050_driverInstanceStruct
  *chartInstance)
{
  c1_set_sim_state_side_effects_c1_mpu6050_driver(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_busy, 2U, 1U, 0U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_mpu6050_driver(chartInstance);
  ...
  *chartInstance)
{
  ...
  uint32_T c1_qY;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
  switch (*chartInstance->c1_is_c1_mpu6050_driver) {
   case c1_IN_cfgDone:
    CV_CHART_EVAL(0, 0, 1);
   ...
   case c1_IN_setupReadGyroZoutL:
    ...
    if (c1_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 51U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy03;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 53U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_enb = false;
   ...
   case c1_IN_check_cfg:
    ...
    if (c1_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 59U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_idle;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 61U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_enb = false;
   ...
   case c1_IN_idle:
    ...
    if (c1_c_out) {
      ...
      if (c1_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 61U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadWhoAmI;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c1_sfEvent);
        ...
        *chartInstance->c1_reg_addr = 117U;
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 61U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_getDEVID;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 33U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_enb = true;
...
static void c1_setupReadWhoAmI(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy0;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusy0(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_check_cfg;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 59U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
    ...
    *chartInstance->c1_cnt = 0U;
    ...
    if (c1_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readWhoAmI1;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c1_sfEvent);
    } else {
...
static void c1_readWhoAmI1(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadPwrMgmt1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_cnt = 0U;
    ...
    if (c1_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 9U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readPwrManagement1;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
    } else {
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupFS_SEL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  *chartInstance->c1_data_out = 0U;
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusy2(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_cfgDone;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_isDeviceSetup = true;
...
static void c1_cfgDone(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
  *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadAccelXoutH;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c1_sfEvent);
  *chartInstance->c1_enb = true;
...
static void c1_getDEVID(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 33U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_b_IN_waitforNotBusy1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 37U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 37U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readDEVID;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 35U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_deviceId = *chartInstance->c1_data_in;
    ...
    if (c1_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 37U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_debuggingState;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 32U, *chartInstance->c1_sfEvent);
    } else {
...
static void c1_readDEVID(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 35U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_getRegData;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 34U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_getRegData(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 34U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy5;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 38U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusy5(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 38U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readUserRegData;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 36U, *chartInstance->c1_sfEvent);
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 50U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy01;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 52U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_readGyroXoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 41U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadGyroYoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 48U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_waitforNotBusy01(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 52U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readGyroZoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 44U, *chartInstance->c1_sfEvent);
...
static void c1_readGyroYoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 42U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadGyroYoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 49U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_waitforNotBusy06(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 56U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readGyroXoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 40U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
...
static void c1_readGyroYoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 43U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadGyroZoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 50U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_waitforNotBusy04(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 54U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readGyroYoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 42U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
...
static void c1_readGyroZoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 45U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_Valid;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 58U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusy03(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 53U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readGyroZoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 45U, *chartInstance->c1_sfEvent);
...
static void c1_waitforNotBusy05(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 55U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_b_IN_readGyroYoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 43U, *chartInstance->c1_sfEvent);
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 47U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy07;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 57U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_readGyroZoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 44U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadGyroZoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 51U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 48U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy04;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 54U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 46U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy06;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 56U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusya6(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 29U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readAccelZoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 16U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
...
static void c1_readAccelZoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 16U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadAccelZoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 24U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 19U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusya1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 25U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusya7(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 30U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readAccelZoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 17U, *chartInstance->c1_sfEvent);
...
static void c1_readAccelXoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadAccelXoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_waitforNotBusya3(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 26U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readAccelXoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, *chartInstance->c1_sfEvent);
...
static void c1_readAccelYoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 15U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadAccelYoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 22U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_readAccelXoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 14U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadAccelYoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusya4;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 27U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 24U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusya7;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 30U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 23U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusya6;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 29U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusya5(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 28U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readGyroYoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 18U, *chartInstance->c1_sfEvent);
...
static void c1_waitforNotBusya1(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 25U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readAccelXoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
...
static void c1_waitforNotBusya4(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 27U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readAccelYoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 15U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 22U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusya5;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 28U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_readAccelZoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 17U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadGyroXoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 46U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusya3;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 26U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_b_readGyroYoutL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 18U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadAccelZoutH;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 23U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_waitforNotBusy07(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 57U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_readGyroXoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 41U, *chartInstance->c1_sfEvent);
...
static void c1_readGyroXoutH(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 40U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupReadGyroXoutL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 47U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
  ...
  *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 49U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy05;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 55U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static void c1_waitforNotBusy3(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_setupWritePwrMgmt1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
...
static void c1_setupFS_SEL(SFc1_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c1_data_out = 16U;
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050_driver = c1_IN_waitforNotBusy3;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_mpu6050_driverInstanceStruct *chartInstance;
  chartInstance = (SFc1_mpu6050_driverInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_mpu6050_driver_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_doneDoubleBufferReInit = (boolean_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_is_active_c1_mpu6050_driver = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  chartInstance->c1_is_c1_mpu6050_driver = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
...
void sf_c1_mpu6050_driver_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_mpu6050_driver_get_post_codegen_info(void);
mxArray *sf_c1_mpu6050_driver_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_mpu6050_driver_get_post_codegen_info();
...
mxArray *sf_c1_mpu6050_driver_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_mpu6050_driver_jit_fallback_info(void)
{
...
mxArray *sf_c1_mpu6050_driver_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_mpu6050_driver(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[2269],T\"isDeviceSetup\",},{M[1],M[99],T\"mode\",},{M[1],M[1094],T\"reg_addr\",},{M[1],M[777],T\"reg_byte_mode\",},{M[1],M[2245],T\"regdata\",},{M[1],M[371],T\"rw\",},{M[1],M[158],T\"slv_addr\",},{M[3],M[1089],T\"cnt\",},{M[3],M[2207],T\"tempVal\",},{M[8],M[0],T\"is_active_c1_mpu6050_driver\",}}",
    "100 S'type','srcId','name','auxInfo'{{M[9],M[0],T\"is_c1_mpu6050_driver\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 21, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_mpu6050_driver_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc1_mpu6050_driverInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_mpu6050_driverInstanceStruct *chartInstance =
      (SFc1_mpu6050_driverInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_mpu6050_driverMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_mpu6050_driverMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _mpu6050_driverMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_check_dwork_consistency(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    mxArray *infoStruct = load_mpu6050_driver_optimization_info
...
static void sf_opaque_initialize_c1_mpu6050_driver(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
  initialize_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_mpu6050_driver(void *chartInstanceVar)
{
  enable_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_mpu6050_driver(void *chartInstanceVar)
{
  disable_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_mpu6050_driver(void *chartInstanceVar)
{
  sf_gateway_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_mpu6050_driver(void *chartInstanceVar)
{
  ext_mode_exec_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_mpu6050_driver(SimStruct* S)
{
  return get_sim_state_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_mpu6050_driver(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c1_mpu6050_driver(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_mpu6050_driverInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_mpu6050_driver_optimization_info();
    }

    finalize_c1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_mpu6050_driver((SFc1_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_mpu6050_driver(SimStruct *S)
{
  int i;
...
mxArray *sf_c1_mpu6050_driver_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x2'varName','path'{{T\"is_active_c1_mpu6050_driver\",T\"is_active_c1_mpu6050_driver\"},{T\"is_c1_mpu6050_driver\",T\"is_c1_mpu6050_driver\"}}"
  };
...
static void mdlSetWorkWidths_c1_mpu6050_driver(SimStruct *S)
{
...
static void mdlRTW_c1_mpu6050_driver(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_mpu6050_driver(SimStruct *S)
{
  SFc1_mpu6050_driverInstanceStruct *chartInstance;
  chartInstance = (SFc1_mpu6050_driverInstanceStruct *)utMalloc(sizeof
    (SFc1_mpu6050_driverInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_mpu6050_driverInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_mpu6050_driver;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_mpu6050_driver;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_mpu6050_driver;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_mpu6050_driver;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_mpu6050_driver;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_mpu6050_driver;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_mpu6050_driver;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_mpu6050_driver;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_mpu6050_driver;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_mpu6050_driver;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_mpu6050_driver;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c1_mpu6050_driver;
  ...
  mdl_start_c1_mpu6050_driver(chartInstance);
}

void c1_mpu6050_driver_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_mpu6050_driver(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_mpu6050_driver(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_mpu6050_driver(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_mpu6050_driver_method_dispatcher.\n"
