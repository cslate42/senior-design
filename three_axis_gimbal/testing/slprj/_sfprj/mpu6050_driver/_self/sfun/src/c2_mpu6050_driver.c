...
static void initialize_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void initialize_params_c2_mpu6050_driver
  (SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void enable_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void disable_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_mpu6050_driver
  (SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void ext_mode_exec_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_mpu6050_driver
  (SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void set_sim_state_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_mpu6050_driver
  (SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void finalize_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void sf_gateway_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void mdl_start_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void initSimStructsc2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_enter_atomic_idle(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_idle(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ready(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_mastr_ack_data_cnf1(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_mastr_ack_data_cnf(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_enter_atomic_scl_ext_n(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_mastr_ack_data(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_enter_atomic_cmd_slave_addr_n(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_cmd_slave_addr_n(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_Increment_Byte_count1(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_cmd_slave_addr_p(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_end1(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_cmd_reg_read_data_p(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_ack_end(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_recv_wr3(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_data(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_slv(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_cmd_reg_read_data_n(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_ack_recv_wr(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_cmd_reg_data_p(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_addr_m_cnf(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_wr_p(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_error_ack(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_enter_atomic_cmd_reg_data_n(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_cmd_reg_data_n(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_delay(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_enter_atomic_cmd_reg_addr_n(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_cmd_reg_addr_n(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_repeat_strt_n(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ready_repeated(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_cmd_reg_addr_p(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ready_repeated_dummy(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_ack_addr_m(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_recv_wr1(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_recv_wr2(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_enter_atomic_cmd_slave_addr_n1(SFc2_mpu6050_driverInstanceStruct *
  chartInstance);
static void c2_cmd_slave_addr_n1(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_cmd_slave_addr_p1(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void c2_ack_addrm1(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_read_n(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_wr_p2(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_read_p(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_slv1(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void c2_ack_slv_cnf1(SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static boolean_T c2_b_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_sf_internal_predicateOutput, const char_T
  *c2_identifier);
static boolean_T c2_c_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_b_bit_cnt, const char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_b_data_out, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_i_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_b_dataWrittenToVector, const char_T
  *c2_identifier, boolean_T c2_y[12]);
static void c2_j_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  boolean_T c2_y[12]);
static const mxArray *c2_k_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_b_setSimStateSideEffectsInfo, const char_T
  *c2_identifier);
static const mxArray *c2_l_emlrt_marshallIn(SFc2_mpu6050_driverInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc2_mpu6050_driverInstanceStruct *chartInstance, int32_T c2_ssid);
static void c2_init_sf_message_store_memory(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void init_test_point_addr_map(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void **get_test_point_address_map(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static rtwCAPI_ModelMappingInfo *get_test_point_mapping_info
  (SFc2_mpu6050_driverInstanceStruct *chartInstance);
static void **get_dataset_logging_obj_vector(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_mpu6050_driverInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_mpu6050_driver(chartInstance);
  ...
  *chartInstance->c2_is_active_c2_mpu6050_driver = 0U;
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance->c2_is_active_c2_mpu6050_driver = 1U;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, *chartInstance->c2_sfEvent);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, *chartInstance->c2_sfEvent);
  _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 15U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_idle;
...
static void ext_mode_exec_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance)
{
  c2_update_debugger_state_c2_mpu6050_driver(chartInstance);
}
  ...
  (SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  c2_m_hoistedGlobal = *chartInstance->c2_is_active_c2_mpu6050_driver;
  c2_o_y = NULL;
  sf_mex_assign(&c2_o_y, sf_mex_create("y", &c2_m_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 12, c2_o_y);
  c2_n_hoistedGlobal = *chartInstance->c2_is_c2_mpu6050_driver;
  c2_p_y = NULL;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_is_active_c2_mpu6050_driver = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c2_mpu6050_driver",
       c2_u, 12)), "is_active_c2_mpu6050_driver");
  *chartInstance->c2_is_c2_mpu6050_driver = c2_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c2_mpu6050_driver", c2_u, 13)),
    "is_c2_mpu6050_driver");
...
static void sf_gateway_c2_mpu6050_driver(SFc2_mpu6050_driverInstanceStruct
  *chartInstance)
{
  c2_set_sim_state_side_effects_c2_mpu6050_driver(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_enb, 3U, 1U, 0U,
                        *chartInstance->c2_sfEvent, false);
  *chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_mpu6050_driver(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, *chartInstance->c2_sfEvent);
  switch (*chartInstance->c2_is_c2_mpu6050_driver) {
   ...
   case c2_IN_repeat_strt_p:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 38U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_slave_addr_n1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 23U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_scl = false;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 39U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_scl_ext_p;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 40U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_scl = true;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 40U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_stop;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 43U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_busy = true;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 41U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_start_p;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 42U, *chartInstance->c2_sfEvent);
   ...
   case c2_IN_start_p:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 42U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_slave_addr_n;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 22U, *chartInstance->c2_sfEvent);
   ...
   case c2_IN_stop:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 43U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_stop_ext;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 44U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_scl = false;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 45U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_write_p;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 46U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_scl = true;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 46U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_slv;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, *chartInstance->c2_sfEvent);
...
static void c2_idle(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_busy = false;
  ...
  if (c2_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 28U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ready;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 34U, *chartInstance->c2_sfEvent);
...
static void c2_ready(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 34U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_start_n;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 41U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 31U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_scl_ext_n;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 39U, *chartInstance->c2_sfEvent);
  c2_enter_atomic_scl_ext_n(chartInstance);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 30U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_Increment_Byte_count1;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c2_sfEvent);
...
static void c2_mastr_ack_data(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  if (c2_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 29U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_mastr_ack_data_cnf;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 30U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_mstr_ack = true;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 29U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_mastr_ack_data_cnf1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 31U, *chartInstance->c2_sfEvent);
...
static void c2_cmd_slave_addr_n(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 22U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_slave_addr_p;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 24U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_read_data_n;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_slave_addr_n;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 24U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_write_n;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 45U, *chartInstance->c2_sfEvent);
...
static void c2_ack_end1(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_end;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    *chartInstance->c2_ack = true;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_mastr_ack_data;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 29U, *chartInstance->c2_sfEvent);
  ...
  if (c2_out) {
    ...
    if (c2_b_out) {
      ...
      *chartInstance->c2_ack = false;
      ...
      _SFD_SYMBOL_SCOPE_POP();
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c2_sfEvent);
      *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_data_n;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 18U, *chartInstance->c2_sfEvent);
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_error_ack;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 27U, *chartInstance->c2_sfEvent);
...
static void c2_ack_recv_wr3(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_recv_wr;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, *chartInstance->c2_sfEvent);
...
static void c2_ack_data(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_end1;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c2_sfEvent);
...
static void c2_ack_slv(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_recv_wr3;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_read_data_p;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c2_sfEvent);
...
static void c2_ack_recv_wr(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_wr_p;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_data_n;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 19U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_data;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c2_sfEvent);
  ...
  if (c2_out) {
    ...
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_data_n;
    ...
    if (c2_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c2_sfEvent);
      *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_delay;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 26U, *chartInstance->c2_sfEvent);
...
static void c2_ack_wr_p(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 14U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_addr_n;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 16U, *chartInstance->c2_sfEvent);
...
static void c2_cmd_reg_data_n(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 18U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_data_p;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c2_sfEvent);
...
static void c2_delay(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 26U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ready_repeated;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 35U, *chartInstance->c2_sfEvent);
...
static void c2_cmd_reg_addr_n(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 16U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_addr_p;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 17U, *chartInstance->c2_sfEvent);
...
static void c2_repeat_strt_n(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_busy = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 37U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_repeat_strt_p;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 38U, *chartInstance->c2_sfEvent);
...
static void c2_ready_repeated(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 35U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ready_repeated_dummy;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 36U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_reg_addr_n;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 17U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_addr_m;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 36U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_repeat_strt_n;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 37U, *chartInstance->c2_sfEvent);
...
static void c2_ack_addr_m(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  if (c2_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_addrm1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c2_sfEvent);
    ...
    *chartInstance->c2_reg_addr_burst = true;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_recv_wr1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c2_sfEvent);
...
static void c2_ack_recv_wr1(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_recv_wr2;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c2_sfEvent);
...
static void c2_ack_recv_wr2(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 9U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_addr_m_cnf;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 23U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_slave_addr_p1;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 25U, *chartInstance->c2_sfEvent);
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_cmd_slave_addr_n1;
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 25U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_read_n;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 32U, *chartInstance->c2_sfEvent);
...
static void c2_read_n(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 32U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_read_p;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 33U, *chartInstance->c2_sfEvent);
...
static void c2_read_p(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 33U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_slv1;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, *chartInstance->c2_sfEvent);
...
static void c2_ack_slv1(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = false;
  ...
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 12U, *chartInstance->c2_sfEvent);
  *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_slv_cnf1;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, *chartInstance->c2_sfEvent);
...
static void c2_ack_slv_cnf1(SFc2_mpu6050_driverInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c2_scl = true;
  ...
  if (c2_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_mpu6050_driver = c2_IN_ack_wr_p2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 15U, *chartInstance->c2_sfEvent);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_mpu6050_driverInstanceStruct *chartInstance;
  chartInstance = (SFc2_mpu6050_driverInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_mpu6050_driver_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance, const mxArray *c2_b_bit_cnt, const char_T *c2_identifier)
{
  ...
  c2_thisId.fParent = NULL;
  c2_thisId.bParentIsCell = false;
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_bit_cnt),
    &c2_thisId);
  sf_mex_destroy(&c2_b_bit_cnt);
  return c2_y;
}
...
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_b_bit_cnt;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  uint8_T c2_y;
  SFc2_mpu6050_driverInstanceStruct *chartInstance;
  chartInstance = (SFc2_mpu6050_driverInstanceStruct *)chartInstanceVoid;
  c2_b_bit_cnt = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = (const char *)c2_identifier;
  c2_thisId.fParent = NULL;
  c2_thisId.bParentIsCell = false;
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_doneDoubleBufferReInit = (boolean_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_is_active_c2_mpu6050_driver = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  chartInstance->c2_is_c2_mpu6050_driver = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
  ...
  chartInstance->c2_busy = (boolean_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_bit_cnt = (uint8_T *)ssGetDWork_wrapper(chartInstance->S, 4);
  ...
  chartInstance->c2_n_ack = (boolean_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c2_reg_byte_cnt = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 5);
  ...
  chartInstance->c2_data_out = (uint8_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 9);
  chartInstance->c2_temp_data = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    6);
}
...
void sf_c2_mpu6050_driver_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2088335629U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2782865138U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1973293796U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2223547731U);
}

mxArray* sf_c2_mpu6050_driver_get_post_codegen_info(void);
mxArray *sf_c2_mpu6050_driver_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_mpu6050_driver_get_post_codegen_info();
...
mxArray *sf_c2_mpu6050_driver_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_mpu6050_driver_jit_fallback_info(void)
{
...
mxArray *sf_c2_mpu6050_driver_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_mpu6050_driver(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x5'type','srcId','name','auxInfo'{{M[3],M[1870],T\"reg_byte_cnt\",},{M[3],M[2305],T\"temp_data\",},{M[8],M[0],T\"is_active_c2_mpu6050_driver\",},{M[9],M[0],T\"is_c2_mpu6050_driver\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 15, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_mpu6050_driver_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc2_mpu6050_driverInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_mpu6050_driverInstanceStruct *chartInstance =
      (SFc2_mpu6050_driverInstanceStruct *)sf_get_chart_instance_ptr(S);
...
{
  return "skYyxnfK5pXpkOdtBIu4MSF";
}
...
static void sf_opaque_initialize_c2_mpu6050_driver(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
  initialize_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_mpu6050_driver(void *chartInstanceVar)
{
  enable_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_mpu6050_driver(void *chartInstanceVar)
{
  disable_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_mpu6050_driver(void *chartInstanceVar)
{
  sf_gateway_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_mpu6050_driver(void *chartInstanceVar)
{
  ext_mode_exec_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_mpu6050_driver(SimStruct* S)
{
  return get_sim_state_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_mpu6050_driver(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_mpu6050_driver(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_mpu6050_driverInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_mpu6050_driver_optimization_info();
    }

    finalize_c2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
      chartInstanceVar);
    if (!sim_mode_is_rtw_gen(S)) {
...
{
  initSimStructsc2_mpu6050_driver((SFc2_mpu6050_driverInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_mpu6050_driver(SimStruct *S)
{
  int i;
...
mxArray *sf_c2_mpu6050_driver_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x3'varName','path'{{T\"is_active_c2_mpu6050_driver\",T\"is_active_c2_mpu6050_driver\"},{T\"is_c2_mpu6050_driver\",T\"is_c2_mpu6050_driver\"},{T\"bit_cnt\",T\"bit_cnt\"}}"
  };
...
static void sf_set_sfun_dwork_info(SimStruct *S)
{
  const char *dworkEncStr[] = {
    "100 S1x7'type','isSigned','wordLength','bias','slope','exponent','isScaledDouble','isComplex','size','local_queue_dwork_idx','local_queue_id'{{T\"int32\",,,,,,,M[0],M[],M[-1],M[-1]},{T\"boolean\",,,,,,,M[0],M[],M[-1],M[-1]},{T\"uint8\",,,,,,,M[0],M[],M[-1],M[-1]},{T\"uint8\",,,,,,,M[0],M[],M[-1],M[-1]},{T\"uint8\",,,,,,,M[0],M[],M[-1],M[-1]},{T\"uint8\",,,,,,,M[0],M[],M[-1],M[-1]},{T\"uint8\",,,,,,,M[0],M[],M[-1],M[-1]}}"
  };
...
{
  static uint32_T checksum[4] = { 762987745U, 2290496466U, 2471380714U,
    975819282U };

  return checksum;
}

static void mdlSetWorkWidths_c2_mpu6050_driver(SimStruct *S)
{
  ...
  if (sim_mode_is_modelref_sim(S)) {
    ...
    ssSetChecksum0(S,(2592996743U));
    ssSetChecksum1(S,(1636078277U));
    ssSetChecksum2(S,(1104666606U));
    ssSetChecksum3(S,(1559126641U));
  }
...
static void mdlRTW_c2_mpu6050_driver(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_mpu6050_driver(SimStruct *S)
{
  SFc2_mpu6050_driverInstanceStruct *chartInstance;
  chartInstance = (SFc2_mpu6050_driverInstanceStruct *)utMalloc(sizeof
    (SFc2_mpu6050_driverInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_mpu6050_driverInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_mpu6050_driver;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_mpu6050_driver;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_mpu6050_driver;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_mpu6050_driver;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_mpu6050_driver;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_mpu6050_driver;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_mpu6050_driver;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_mpu6050_driver;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_mpu6050_driver;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_mpu6050_driver;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_mpu6050_driver;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_mpu6050_driver;
  ...
  mdl_start_c2_mpu6050_driver(chartInstance);
}

void c2_mpu6050_driver_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_mpu6050_driver(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_mpu6050_driver(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_mpu6050_driver(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_mpu6050_driver_method_dispatcher.\n"
