-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mpu6050_working\ADXL345_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ADXL345_ip_axi_lite
-- Source Path: ADXL345_ip/ADXL345_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END ADXL345_ip_axi_lite;


ARCHITECTURE rtl OF ADXL345_ip_axi_lite IS
  ...
  COMPONENT ADXL345_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : ADXL345_ip_addr_decoder
    USE ENTITY work.ADXL345_ip_addr_decoder(rtl);

  FOR ALL : ADXL345_ip_axi_lite_module
    USE ENTITY work.ADXL345_ip_axi_lite_module(rtl);
...
BEGIN
  u_ADXL345_ip_addr_decoder_inst : ADXL345_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_isDeviceSetup => read_isDeviceSetup,  -- ufix1
  ...
  u_ADXL345_ip_axi_lite_module_inst : ADXL345_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
