...
ARCHITECTURE rtl OF ADXL345_ip IS
  ...
  SIGNAL const_zero_1                     : unsigned(6 DOWNTO 0);  -- ufix7
...
BEGIN
  ...
  const_zero <= to_unsigned(16#00#, 6);

  GPLEDs_tmp <= const_zero & unsigned'(ADDRALT_sig & CS_sig);

  GPLEDs <= std_logic_vector(GPLEDs_tmp);

  const_zero_1 <= to_unsigned(16#00#, 7);

  PmodJA1_tmp <= const_zero_1 & SCL_sig;
