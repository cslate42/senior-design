###########################################################################
## Makefile generated for Simulink model 'gm_mpu6050_working_interface'. 
## 
## Makefile     : gm_mpu6050_working_interface.mk
## Generated on : Mon Dec 04 00:39:44 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gm_mpu6050_working_interface
...
PRODUCT_NAME              = gm_mpu6050_working_interface
MAKEFILE                  = gm_mpu6050_working_interface.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = F:/MATLAB/three_axis_gimbal/MPU6050
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = gm_mpu6050_working_interface_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gm_mpu6050_working_interface
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/zynq/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/gm_mpu6050_working_interface_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=gm_mpu6050_working_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=gm_mpu6050_working_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = gm_mpu6050_working_interface.c.o gm_mpu6050_working_interface_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o axi4Lite.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/gm_mpu6050_working_interface_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/gm_mpu6050_working_interface_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/gm_mpu6050_working_interface_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
