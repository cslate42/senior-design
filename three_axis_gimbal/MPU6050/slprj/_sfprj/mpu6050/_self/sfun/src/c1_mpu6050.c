...
#define c1_IN_setupReadPwrMgmt1        ((uint8_T)4U)
#define c1_IN_setupReadWhoAmI          ((uint8_T)5U)
#define c1_IN_setupWritePwrMgmt1       ((uint8_T)6U)
#define c1_IN_waitforNotBusy0          ((uint8_T)7U)
#define c1_IN_waitforNotBusy1          ((uint8_T)8U)
#define c1_IN_waitforNotBusy2          ((uint8_T)9U)
#define c1_IN_accelX_LSB               ((uint8_T)10U)
#define c1_IN_accelX_MSB               ((uint8_T)11U)
#define c1_IN_accelY_LSB               ((uint8_T)12U)
#define c1_IN_accelY_MSB               ((uint8_T)13U)
#define c1_IN_accelZ_LSB               ((uint8_T)14U)
#define c1_IN_accelZ_MSB               ((uint8_T)15U)
#define c1_IN_read_accelX_registers0   ((uint8_T)16U)
#define c1_IN_toggle                   ((uint8_T)17U)
#define c1_IN_toggle1                  ((uint8_T)18U)
#define c1_IN_toggle2                  ((uint8_T)19U)
#define c1_IN_toggle3                  ((uint8_T)20U)
#define c1_IN_toggle4                  ((uint8_T)21U)
#define c1_b_IN_waitforNotBusy2        ((uint8_T)22U)
#define c1_IN_getDEVID                 ((uint8_T)23U)
#define c1_IN_getRegData               ((uint8_T)24U)
#define c1_IN_readDEVID                ((uint8_T)25U)
#define c1_IN_readUserRegData          ((uint8_T)26U)
#define c1_b_IN_waitforNotBusy1        ((uint8_T)27U)
#define c1_IN_waitforNotBusy5          ((uint8_T)28U)
#define c1_IN_waitforNotBusy6          ((uint8_T)29U)
#define c1_IN_gyroX_LSB                ((uint8_T)30U)
#define c1_IN_gyroX_MSB                ((uint8_T)31U)
#define c1_IN_gyroY_LSB                ((uint8_T)32U)
#define c1_IN_gyroY_MSB                ((uint8_T)33U)
#define c1_IN_gyroZ_LSB                ((uint8_T)34U)
#define c1_IN_gyroZ_MSB                ((uint8_T)35U)
#define c1_IN_read_gyroX_registers0    ((uint8_T)36U)
#define c1_b_IN_toggle                 ((uint8_T)37U)
#define c1_b_IN_toggle1                ((uint8_T)38U)
#define c1_b_IN_toggle2                ((uint8_T)39U)
#define c1_b_IN_toggle3                ((uint8_T)40U)
#define c1_b_IN_toggle4                ((uint8_T)41U)
#define c1_c_IN_waitforNotBusy2        ((uint8_T)42U)
#define c1_IN_Valid                    ((uint8_T)43U)
#define c1_IN_check_cfg                ((uint8_T)44U)
#define c1_IN_idle                     ((uint8_T)45U)
#define c1_IN_init                     ((uint8_T)46U)
...
static void c1_setupReadWhoAmI(SFc1_mpu6050InstanceStruct *chartInstance);
static void c1_waitforNotBusy0(SFc1_mpu6050InstanceStruct *chartInstance);
static void c1_readWhoAmI1(SFc1_mpu6050InstanceStruct *chartInstance);
static void c1_setupReadPwrMgmt1(SFc1_mpu6050InstanceStruct *chartInstance);
static void c1_waitforNotBusy1(SFc1_mpu6050InstanceStruct *chartInstance);
static void c1_readPwrManagement1(SFc1_mpu6050InstanceStruct *chartInstance);
static void c1_setupWritePwrMgmt1(SFc1_mpu6050InstanceStruct *chartInstance);
...
static void c1_b_waitforNotBusy1(SFc1_mpu6050InstanceStruct *chartInstance);
...
static void initialize_c1_mpu6050(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  *chartInstance->c1_selfInit = false;
  ...
  if (!(sf_get_output_port_reusable(chartInstance->S, 25) != 0)) {
    *chartInstance->c1_tmpData = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpData, 35U, 1U, 0U,
                          *chartInstance->c1_sfEvent, false);
  }
  ...
  *chartInstance->c1_Valid_Out = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_Valid_Out, 21U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_selfInit = true;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_selfInit, 1U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_slv_addr = chartInstance->c1_SlvAddr;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_slv_addr, 14U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmp = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmp, 27U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpConfig = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpConfig, 28U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpReadGyro = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpReadGyro, 30U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpReadAccel = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpReadAccel, 31U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpValid = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpValid, 32U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpReadDevice = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpReadDevice, 33U, 4U, 50U, *
                        chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpHere = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpHere, 34U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpData = 128U;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpData, 35U, 4U, 50U,
                        *chartInstance->c1_sfEvent, false);
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c1_is_c1_mpu6050 == c1_IN_readPwrManagement1) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
  }

  if (*chartInstance->c1_is_c1_mpu6050 == c1_IN_setupWritePwrMgmt1) {
  ...
  if (*chartInstance->c1_is_c1_mpu6050 == c1_b_IN_waitforNotBusy1) {
  ...
  switch (*chartInstance->c1_is_c1_mpu6050) {
   ...
   case c1_c_IN_waitforNotBusy2:
    ...
    c1_out = (CV_TRANSITION_EVAL(46U, (int32_T)_SFD_CCP_CALL(46U, 0,
      ...
      *chartInstance->c1_mstr_ack, 1.0, 0, 0U, (int32_T)
      *chartInstance->c1_mstr_ack) != 0U, *chartInstance->c1_sfEvent)) != 0);
    if (c1_out) {
      ...
      *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tempVal, 2U, 4U, 33U,
                            *chartInstance->c1_sfEvent, false);
    } else {
    ...
    if (c1_b_out) {
      ...
      *chartInstance->c1_enb = false;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 47U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_cnt = 0U;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_cnt, 0U, 4U, 47U,
                            *chartInstance->c1_sfEvent, false);
    } else {
      ...
      c1_i0 = 1;
      if (CV_SATURATION_EVAL(4, 46, 0, 0, c1_i0 < 0)) {
        c1_i0 = 0;
      }

      c1_qY = c1_q0 + (uint32_T)c1_i0;
      if (CV_SATURATION_EVAL(4, 46, 0, 0, c1_qY < c1_q0)) {
        c1_qY = MAX_uint32_T;
      }

      *chartInstance->c1_cnt = c1_qY;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_cnt, 0U, 4U, 46U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_tmpValid = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpValid, 32U, 4U, 46U,
                            *chartInstance->c1_sfEvent, false);
    }
   ...
   case c1_IN_check_cfg:
    ...
    c1_c_out = (CV_TRANSITION_EVAL(5U, (int32_T)_SFD_CCP_CALL(5U, 0,
      CV_RELATIONAL_EVAL(5U, 5U, 0, (real_T)*chartInstance->c1_cnt, 5.0, 0, 5U, *
                         chartInstance->c1_cnt >= 5U) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_c_out) {
      ...
      *chartInstance->c1_enb = false;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 49U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_rw = false;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 49U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_mode = false;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 49U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_cnt = 0U;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_cnt, 0U, 4U, 49U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_reg_byte_mode = false;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_byte_mode, 16U, 4U,
                            49U, *chartInstance->c1_sfEvent, false);
    } else {
      _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 47U,
                   *chartInstance->c1_sfEvent);
      c1_b_q0 = *chartInstance->c1_cnt;
      c1_i1 = 1;
      if (CV_SATURATION_EVAL(4, 47, 0, 0, c1_i1 < 0)) {
        c1_i1 = 0;
      }

      c1_b_qY = c1_b_q0 + (uint32_T)c1_i1;
      if (CV_SATURATION_EVAL(4, 47, 0, 0, c1_b_qY < c1_b_q0)) {
      ...
      *chartInstance->c1_tmpCheckCng = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpCheckCng, 29U, 4U, 47U,
                            *chartInstance->c1_sfEvent, false);
   ...
   case c1_IN_idle:
    ...
    c1_d_out = (CV_TRANSITION_EVAL(25U, (int32_T)_SFD_CCP_CALL(25U, 0,
      CV_RELATIONAL_EVAL(5U, 25U, 0, (real_T)*chartInstance->c1_busy, 0.0, 0, 0U,
    ...
    if (c1_d_out) {
      ...
      c1_e_out = (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0,
        ...
        *chartInstance->c1_configDevice | (int32_T)*chartInstance->c1_selfInit),
                           0.0, 0, 1U, ((int32_T)*chartInstance->c1_configDevice
        | (int32_T)*chartInstance->c1_selfInit) != 0) != 0U,
        *chartInstance->c1_sfEvent)) != 0);
      if (c1_e_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 49U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_is_c1_mpu6050 = c1_IN_setupReadWhoAmI;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_enb = true;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 5U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_rw = true;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 5U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_mode = false;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 5U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_reg_addr = 117U;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 5U, *
                              chartInstance->c1_sfEvent, false);
      } else {
        ...
        *chartInstance->c1_enb = true;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 25U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_rw = true;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 25U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_mode = false;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 25U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_reg_addr = 117U;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 25U,
                              *chartInstance->c1_sfEvent, false);
        *chartInstance->c1_tmpReadDevice = true;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpReadDevice, 33U, 4U,
                              25U, *chartInstance->c1_sfEvent, false);
      }
    } else {
    ...
    *chartInstance->c1_cnt = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_cnt, 0U, 4U, 49U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_reg_byte_mode = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_byte_mode, 16U, 4U, 49U,
                          *chartInstance->c1_sfEvent, false);
...
static void c1_setupReadWhoAmI(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_waitforNotBusy0;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 7U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_tmpData = 1U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpData, 35U, 4U, 7U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_waitforNotBusy0(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(58U, (int32_T)_SFD_CCP_CALL(58U, 0,
              CV_RELATIONAL_EVAL(5U, 58U, 0, (real_T)*chartInstance->c1_n_ack,
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_cnt = 0U;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 59U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(59U, (int32_T)_SFD_CCP_CALL(59U, 0,
      CV_RELATIONAL_EVAL(5U, 59U, 0, (real_T)*chartInstance->c1_mstr_ack, 1.0, 0,
                         0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 59U, *chartInstance->c1_sfEvent);
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050 = c1_IN_readWhoAmI1;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c1_sfEvent);
    } else {
...
static void c1_readWhoAmI1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_setupReadPwrMgmt1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 4U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_rw = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 4U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_mode = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 4U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_reg_addr = 107U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 4U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_setupReadPwrMgmt1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_waitforNotBusy1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 8U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_tmpData = 2U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpData, 35U, 4U, 8U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_waitforNotBusy1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(63U, (int32_T)_SFD_CCP_CALL(63U, 0,
              CV_RELATIONAL_EVAL(5U, 63U, 0, (real_T)*chartInstance->c1_n_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_cnt = 0U;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 61U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(61U, (int32_T)_SFD_CCP_CALL(61U, 0,
      CV_RELATIONAL_EVAL(5U, 61U, 0, (real_T)*chartInstance->c1_mstr_ack, 1.0, 0,
                         0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 61U, *chartInstance->c1_sfEvent);
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_is_c1_mpu6050 = c1_IN_readPwrManagement1;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_tmpData = *chartInstance->c1_data_in;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpData, 35U, 4U, 2U,
                            *chartInstance->c1_sfEvent, false);
    } else {
...
static void c1_readPwrManagement1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_setupWritePwrMgmt1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 6U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_rw = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 6U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_mode = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 6U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_reg_addr = 107U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 6U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_data_out = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_data_out, 17U, 4U, 6U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_setupWritePwrMgmt1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  *chartInstance->c1_data_out = 0U;
  ...
  c1_out = (CV_TRANSITION_EVAL(50U, (int32_T)_SFD_CCP_CALL(50U, 0,
              CV_RELATIONAL_EVAL(5U, 50U, 0, (real_T)*chartInstance->c1_busy,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_busy) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_waitforNotBusy2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 9U,
                          *chartInstance->c1_sfEvent, false);
  } else {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_tmp = true;
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 53U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(53U, (int32_T)_SFD_CCP_CALL(53U, 0,
      CV_RELATIONAL_EVAL(5U, 53U, 0, (real_T)*chartInstance->c1_n_ack, 1.0, 0,
...
static void c1_getDEVID(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(17U, (int32_T)_SFD_CCP_CALL(17U, 0,
              CV_RELATIONAL_EVAL(5U, 17U, 0, (real_T)*chartInstance->c1_busy,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_busy) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 17U, *chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 25U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_mpu6050 = c1_b_IN_waitforNotBusy1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 29U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 29U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_b_waitforNotBusy1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(16U, (int32_T)_SFD_CCP_CALL(16U, 0,
              CV_RELATIONAL_EVAL(5U, 16U, 0, (real_T)*chartInstance->c1_mstr_ack,
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_deviceId = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_deviceId, 22U, 4U, 27U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_tmpHere = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpHere, 34U, 4U, 27U,
                          *chartInstance->c1_sfEvent, false);
  } else {
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 19U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(19U, (int32_T)_SFD_CCP_CALL(19U, 0,
      CV_RELATIONAL_EVAL(5U, 19U, 0, (real_T)*chartInstance->c1_n_ack, 1.0, 0,
                         0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
      ...
      *chartInstance->c1_is_c1_mpu6050 = c1_IN_waitforNotBusy6;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 31U, *chartInstance->c1_sfEvent);
      *chartInstance->c1_tmp = (((int32_T)*chartInstance->c1_tmp | 8) != 0);
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmp, 27U, 4U, 31U,
                            *chartInstance->c1_sfEvent, false);
    } else {
...
static void c1_readDEVID(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_getRegData;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 26U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 26U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_rw = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 26U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_mode = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 26U,
                          *chartInstance->c1_sfEvent, false);
    *chartInstance->c1_reg_addr = *chartInstance->c1_userRegAddr;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 26U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_getRegData(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_waitforNotBusy5;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 30U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_enb = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 30U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_waitforNotBusy5(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(22U, (int32_T)_SFD_CCP_CALL(22U, 0,
              CV_RELATIONAL_EVAL(5U, 22U, 0, (real_T)*chartInstance->c1_mstr_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_regdata = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_regdata, 23U, 4U, 28U,
                          *chartInstance->c1_sfEvent, false);
  } else {
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 24U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(24U, (int32_T)_SFD_CCP_CALL(24U, 0,
      CV_RELATIONAL_EVAL(5U, 24U, 0, (real_T)*chartInstance->c1_n_ack, 1.0, 0,
                         0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
  ...
  *chartInstance)
{
  *chartInstance->c1_enb = true;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 17U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_rw = true;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 17U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_mode = true;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 17U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_reg_addr = chartInstance->c1_AccelXRegAddr;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 17U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_Valid_Out = false;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_Valid_Out, 21U, 4U, 17U,
                        *chartInstance->c1_sfEvent, false);
  *chartInstance->c1_tmpReadAccel = true;
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpReadAccel, 31U, 4U, 17U,
                        *chartInstance->c1_sfEvent, false);
}
...
static void c1_b_waitforNotBusy2(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_accelX_LSB;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tempVal, 2U, 4U, 11U,
                          *chartInstance->c1_sfEvent, false);
  } else {
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 20U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(20U, (int32_T)_SFD_CCP_CALL(20U, 0,
      CV_RELATIONAL_EVAL(5U, 20U, 0, (real_T)*chartInstance->c1_n_ack, 1.0, 0,
                         0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
...
static void c1_accelX_LSB(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(8U, (int32_T)_SFD_CCP_CALL(8U, 0,
              CV_RELATIONAL_EVAL(5U, 8U, 0, (real_T)*chartInstance->c1_mstr_ack,
...
static void c1_toggle(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(6U, (int32_T)_SFD_CCP_CALL(6U, 0,
              CV_RELATIONAL_EVAL(5U, 6U, 0, (real_T)*chartInstance->c1_mstr_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_AccelX = c1_convert_int16(chartInstance,
      *chartInstance->c1_tempVal, *chartInstance->c1_data_in);
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_AccelX, 18U, 4U, 12U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_accelX_MSB(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(13U, (int32_T)_SFD_CCP_CALL(13U, 0,
              CV_RELATIONAL_EVAL(5U, 13U, 0, (real_T)*chartInstance->c1_n_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_cnt = 0U;
    ...
    c1_b_out = (CV_TRANSITION_EVAL(32U, (int32_T)_SFD_CCP_CALL(32U, 0,
      CV_RELATIONAL_EVAL(5U, 32U, 0, (real_T)*chartInstance->c1_mstr_ack, 0.0, 0,
...
static void c1_toggle3(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_accelY_LSB;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tempVal, 2U, 4U, 13U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_toggle1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_AccelY = c1_convert_int16(chartInstance,
      *chartInstance->c1_tempVal, *chartInstance->c1_data_in);
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_AccelY, 19U, 4U, 14U,
                          *chartInstance->c1_sfEvent, false);
  } else {
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_cnt = 0U;
    ...
    c1_b_out = (CV_TRANSITION_EVAL(33U, (int32_T)_SFD_CCP_CALL(33U, 0,
      CV_RELATIONAL_EVAL(5U, 33U, 0, (real_T)*chartInstance->c1_mstr_ack, 0.0, 0,
                         0U, !*chartInstance->c1_mstr_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
...
static void c1_toggle4(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(30U, (int32_T)_SFD_CCP_CALL(30U, 0,
              CV_RELATIONAL_EVAL(5U, 30U, 0, (real_T)*chartInstance->c1_mstr_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_accelZ_LSB;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 15U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tempVal, 2U, 4U, 15U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_toggle2(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_AccelZ = c1_convert_int16(chartInstance,
      *chartInstance->c1_tempVal, *chartInstance->c1_data_in);
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_AccelZ, 20U, 4U, 16U,
                          *chartInstance->c1_sfEvent, false);
  } else {
    ...
    if (c1_b_out) {
      ...
      *chartInstance->c1_enb = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_enb, 11U, 4U, 39U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_rw = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_rw, 12U, 4U, 39U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_mode = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_mode, 13U, 4U, 39U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_reg_addr = chartInstance->c1_GyroXRegAddr;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_reg_addr, 15U, 4U, 39U,
                            *chartInstance->c1_sfEvent, false);
      *chartInstance->c1_Valid_Out = false;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_Valid_Out, 21U, 4U, 39U, *
                            chartInstance->c1_sfEvent, false);
      *chartInstance->c1_tmpReadGyro = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tmpReadGyro, 30U, 4U, 39U,
                            *chartInstance->c1_sfEvent, false);
    } else {
...
static void c1_b_toggle(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_GyroX = c1_convert_int16(chartInstance,
      *chartInstance->c1_tempVal, *chartInstance->c1_data_in);
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_GyroX, 24U, 4U, 34U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_gyroX_MSB(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 39U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(39U, (int32_T)_SFD_CCP_CALL(39U, 0,
      CV_RELATIONAL_EVAL(5U, 39U, 0, (real_T)*chartInstance->c1_mstr_ack, 0.0, 0,
                         0U, !*chartInstance->c1_mstr_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
...
static void c1_b_toggle3(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(36U, (int32_T)_SFD_CCP_CALL(36U, 0,
              CV_RELATIONAL_EVAL(5U, 36U, 0, (real_T)*chartInstance->c1_mstr_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_gyroY_LSB;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 35U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tempVal, 2U, 4U, 35U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_b_toggle1(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(42U, (int32_T)_SFD_CCP_CALL(42U, 0,
              CV_RELATIONAL_EVAL(5U, 42U, 0, (real_T)*chartInstance->c1_mstr_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_mstr_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_GyroY = c1_convert_int16(chartInstance,
      *chartInstance->c1_tempVal, *chartInstance->c1_data_in);
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_GyroY, 25U, 4U, 36U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_gyroY_MSB(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(35U, (int32_T)_SFD_CCP_CALL(35U, 0,
              CV_RELATIONAL_EVAL(5U, 35U, 0, (real_T)*chartInstance->c1_n_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 34U,
                 *chartInstance->c1_sfEvent);
    c1_b_out = (CV_TRANSITION_EVAL(34U, (int32_T)_SFD_CCP_CALL(34U, 0,
      CV_RELATIONAL_EVAL(5U, 34U, 0, (real_T)*chartInstance->c1_mstr_ack, 0.0, 0,
                         0U, !*chartInstance->c1_mstr_ack) != 0U,
      *chartInstance->c1_sfEvent)) != 0);
    if (c1_b_out) {
...
static void c1_b_toggle4(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_is_c1_mpu6050 = c1_IN_gyroZ_LSB;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 37U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_tempVal = *chartInstance->c1_data_in;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_tempVal, 2U, 4U, 37U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_b_toggle2(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_GyroZ = c1_convert_int16(chartInstance,
      *chartInstance->c1_tempVal, *chartInstance->c1_data_in);
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_GyroZ, 26U, 4U, 38U,
                          *chartInstance->c1_sfEvent, false);
  } else {
...
static void c1_gyroZ_MSB(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  c1_out = (CV_TRANSITION_EVAL(37U, (int32_T)_SFD_CCP_CALL(37U, 0,
              CV_RELATIONAL_EVAL(5U, 37U, 0, (real_T)*chartInstance->c1_n_ack,
    1.0, 0, 0U, (int32_T)*chartInstance->c1_n_ack) != 0U,
              *chartInstance->c1_sfEvent)) != 0);
  if (c1_out) {
    ...
    *chartInstance->c1_Valid_Out = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_Valid_Out, 21U, 4U, 46U,
                          *chartInstance->c1_sfEvent, false);
  }
  ...
  uint8_T c1_msb, uint8_T c1_lsb)
{
  ...
  int16_T c1_c_a;
  int16_T c1_b;
  _SFD_DATA_RANGE_CHECK((real_T)c1_lsb, 37U, 4U, 48U, *chartInstance->c1_sfEvent,
                        false);
  _SFD_DATA_RANGE_CHECK((real_T)c1_msb, 36U, 4U, 48U, *chartInstance->c1_sfEvent,
                        false);
  _SFD_SET_DATA_VALUE_PTR(38U, &c1_val);
  _SFD_SET_DATA_VALUE_PTR(37U, &c1_lsb);
  _SFD_SET_DATA_VALUE_PTR(36U, &c1_msb);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_val, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(48, 0);
  _SFD_EML_CALL(48U, *chartInstance->c1_sfEvent, 3);
  c1_a = c1_msb;
  c1_b_a = c1_a;
  ...
  _SFD_DATA_RANGE_CHECK((real_T)c1_val, 38U, 4U, 48U, *chartInstance->c1_sfEvent,
                        false);
  _SFD_EML_CALL(48U, *chartInstance->c1_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
...
static void init_simulink_io_address(SFc1_mpu6050InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_tmpHere = (boolean_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 24);
  chartInstance->c1_tmpData = (uint8_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 25);
}
...
static const mxArray *sf_get_sim_state_info_c1_mpu6050(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[2339],T\"tmpHere\",},{M[1],M[2336],T\"tmpReadAccel\",},{M[1],M[2338],T\"tmpReadDevice\",},{M[1],M[2335],T\"tmpReadGyro\",},{M[1],M[2337],T\"tmpValid\",},{M[3],M[1089],T\"cnt\",},{M[3],M[2269],T\"selfInit\",},{M[3],M[2207],T\"tempVal\",},{M[8],M[0],T\"is_active_c1_mpu6050\",},{M[9],M[0],T\"is_c1_mpu6050\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(43U, (void *)&chartInstance->c1_SlvAddr);
        _SFD_SET_DATA_VALUE_PTR(39U, (void *)&chartInstance->c1_AccelXRegAddr);
        _SFD_SET_DATA_VALUE_PTR(40U, (void *)&chartInstance->c1_AccelYRegAddr);
        _SFD_SET_DATA_VALUE_PTR(41U, (void *)&chartInstance->c1_AccelZRegAddr);
        ...
        _SFD_SET_DATA_VALUE_PTR(35U, (void *)chartInstance->c1_tmpData);
      }
    }
  }
}
