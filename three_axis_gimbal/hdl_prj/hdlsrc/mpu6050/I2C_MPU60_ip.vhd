-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mpu6050\I2C_MPU60_ip.vhd
...
ARCHITECTURE rtl OF I2C_MPU60_ip IS

  -- Component Declarations
  COMPONENT I2C_MPU60_ip_axi_lite
  ...
  FOR ALL : I2C_MPU60_ip_axi_lite
    USE ENTITY work.I2C_MPU60_ip_axi_lite(rtl);

  FOR ALL : I2C_MPU60_ip_dut
    USE ENTITY work.I2C_MPU60_ip_dut(rtl);
...
BEGIN
  u_I2C_MPU60_ip_axi_lite_inst : I2C_MPU60_ip_axi_lite
  ...
  u_I2C_MPU60_ip_dut_inst : I2C_MPU60_ip_dut
