-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mpu6050\I2C_MPU60_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2C_MPU60_ip_axi_lite
-- Source Path: I2C_MPU60_ip/I2C_MPU60_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY I2C_MPU60_ip_axi_lite IS
...
END I2C_MPU60_ip_axi_lite;


ARCHITECTURE rtl OF I2C_MPU60_ip_axi_lite IS

  -- Component Declarations
  COMPONENT I2C_MPU60_ip_addr_decoder
  ...
  COMPONENT I2C_MPU60_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : I2C_MPU60_ip_addr_decoder
    USE ENTITY work.I2C_MPU60_ip_addr_decoder(rtl);

  FOR ALL : I2C_MPU60_ip_axi_lite_module
    USE ENTITY work.I2C_MPU60_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_RegAddr_tmp                : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  u_I2C_MPU60_ip_addr_decoder_inst : I2C_MPU60_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_AccelX => read_AccelX,  -- sfix16
              read_AccelY => read_AccelY,  -- sfix16
              read_AccelZ => read_AccelZ,  -- sfix16
              read_validout => read_validout,  -- ufix1
              read_deviceID => read_deviceID,  -- ufix8
              read_RegData => read_RegData,  -- ufix8
              read_GyroX => read_GyroX,  -- sfix16
              read_GyroY => read_GyroY,  -- sfix16
              read_GyroZ => read_GyroZ,  -- sfix16
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_ConfigDevice => write_ConfigDevice,  -- ufix1
              write_RegAddr => write_RegAddr_tmp  -- ufix8
              );

  u_I2C_MPU60_ip_axi_lite_module_inst : I2C_MPU60_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_RegAddr <= write_RegAddr_tmp;
