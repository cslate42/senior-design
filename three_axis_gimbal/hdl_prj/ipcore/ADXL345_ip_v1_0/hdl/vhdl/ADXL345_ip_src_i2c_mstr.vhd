  ...
  BEGIN
    ...
    CASE is_i2c_mstr IS
      WHEN IN_Increment_Byte_count1 =>
        mstr_ack_reg_next <= '0';
        --During 'Increment_Byte_count1': '<S9>:2187'
        --Transition: '<S9>:2271'
        is_i2c_mstr_next <= IN_cmd_reg_read_data_n;
        --Entry 'cmd_reg_read_data_n': '<S9>:2175'
        scl_reg_next <= '0';
        --mstr_ack(:) = 0
        ack_reg_next <= '1';
      WHEN IN_ack_addr_m =>
        scl_reg_next <= '0';
        --During 'ack_addr_m': '<S9>:2183'
        IF reg_addr_burstIn = '1' THEN 
          --Transition: '<S9>:2247'
          is_i2c_mstr_next <= IN_ack_addrm1;
          --Entry 'ack_addrm1': '<S9>:2244'
          scl_reg_next <= '1';
          ack_reg_next <= '0';
      ...
      WHEN IN_ack_addr_m_cnf =>
        scl_reg_next <= '0';
        --During 'ack_addr_m_cnf': '<S9>:2176'
        IF ( NOT rd_wr) = '1' THEN 
          --Transition: '<S9>:2198'
          is_i2c_mstr_next <= IN_cmd_reg_data_n;
          --Entry 'cmd_reg_data_n': '<S9>:2188'
          scl_reg_next <= '0';
          ack_reg_next <= '0';
        ...
        END IF;
      WHEN IN_ack_addrm1 =>
        --During 'ack_addrm1': '<S9>:2244'
        --Transition: '<S9>:2203'
        is_i2c_mstr_next <= IN_cmd_reg_addr_n;
        --Entry 'cmd_reg_addr_n': '<S9>:2172'
        scl_reg_next <= '0';
        ack_reg_next <= '0';
      ...
      WHEN IN_ack_data =>
        --During 'ack_data': '<S9>:2174'
        --Transition: '<S9>:2267'
        is_i2c_mstr_next <= IN_ack_end1;
        --Entry 'ack_end1': '<S9>:2301'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        ack_reg_next <= '1';
      WHEN IN_ack_end =>
        scl_reg_next <= '1';
        --During 'ack_end': '<S9>:2266'
        ...
        ELSE 
          ...
          --Entry 'error_ack': '<S9>:2171'
          scl_reg_next <= '0';
          sda_reg_next <= '1';
          n_ack_reg_next <= '1';
        END IF;
      WHEN IN_ack_end1 =>
        --During 'ack_end1': '<S9>:2301'
        --Transition: '<S9>:2302'
        is_i2c_mstr_next <= IN_ack_end;
        --Entry 'ack_end': '<S9>:2266'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        ack_reg_next <= '1';
      WHEN IN_ack_recv_wr =>
        scl_reg_next <= '1';
        --During 'ack_recv_wr': '<S9>:2260'
        IF ( NOT sda_in) = '1' THEN 
          --Transition: '<S9>:2223'
          is_i2c_mstr_next <= IN_ack_wr_p;
          --Entry 'ack_wr_p': '<S9>:2264'
          scl_reg_next <= '0';
          ack_reg_next <= '0';
          sda_reg_next <= '0';
          bit_cnt_next <= to_unsigned(16#08#, 8);
      ...
      WHEN IN_ack_recv_wr1 =>
        --During 'ack_recv_wr1': '<S9>:2278'
        --Transition: '<S9>:2298'
        is_i2c_mstr_next <= IN_ack_recv_wr2;
        --Entry 'ack_recv_wr2': '<S9>:2297'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        ack_reg_next <= '1';
      WHEN IN_ack_recv_wr2 =>
        scl_reg_next <= '1';
        --During 'ack_recv_wr2': '<S9>:2297'
        IF ( NOT sda_in) = '1' THEN 
          --Transition: '<S9>:2206'
          is_i2c_mstr_next <= IN_ack_addr_m_cnf;
          --Entry 'ack_addr_m_cnf': '<S9>:2176'
          scl_reg_next <= '0';
      ...
      WHEN IN_ack_recv_wr3 =>
        --During 'ack_recv_wr3': '<S9>:2303'
        --Transition: '<S9>:2304'
        is_i2c_mstr_next <= IN_ack_recv_wr;
        --Entry 'ack_recv_wr': '<S9>:2260'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        ack_reg_next <= '1';
        bit_cnt_next <= to_unsigned(16#08#, 8);
      WHEN IN_ack_slv =>
        --During 'ack_slv': '<S9>:2170'
        --Transition: '<S9>:2261'
        is_i2c_mstr_next <= IN_ack_recv_wr3;
        --Entry 'ack_recv_wr3': '<S9>:2303'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        ack_reg_next <= '1';
      WHEN IN_ack_slv1 =>
        --During 'ack_slv1': '<S9>:2219'
        --Transition: '<S9>:2259'
        is_i2c_mstr_next <= IN_ack_slv_cnf1;
        --Entry 'ack_slv_cnf1': '<S9>:2194'
        scl_reg_next <= '1';
        ack_reg_next <= '1';
        bit_cnt_next <= to_unsigned(16#08#, 8);
      WHEN IN_ack_slv_cnf1 =>
        scl_reg_next <= '1';
        --During 'ack_slv_cnf1': '<S9>:2194'
        IF ( NOT sda_in) = '1' THEN 
          --Transition: '<S9>:2239'
          is_i2c_mstr_next <= IN_ack_wr_p2;
          --Entry 'ack_wr_p2': '<S9>:2274'
          scl_reg_next <= '0';
          ack_reg_next <= '1';
          sda_reg_next <= '1';
        ELSE 
      ...
      WHEN IN_cmd_reg_addr_n =>
        reg_addr_burst_reg_next <= '0';
        --During 'cmd_reg_addr_n': '<S9>:2172'
        --Transition: '<S9>:2227'
        is_i2c_mstr_next <= IN_cmd_reg_addr_p;
        --Entry 'cmd_reg_addr_p': '<S9>:2178'
        scl_reg_next <= '1';
      ...
      WHEN IN_cmd_reg_addr_p =>
        ...
        ELSE 
          ...
          --Entry 'ack_addr_m': '<S9>:2183'
          scl_reg_next <= '0';
          ack_reg_next <= '1';
          sda_reg_next <= '1';
        END IF;
      WHEN IN_cmd_reg_data_n =>
        --During 'cmd_reg_data_n': '<S9>:2188'
        --Transition: '<S9>:2197'
        is_i2c_mstr_next <= IN_cmd_reg_data_p;
        --Entry 'cmd_reg_data_p': '<S9>:2169'
        scl_reg_next <= '1';
      ...
      WHEN IN_cmd_reg_data_p =>
        ...
        ELSE 
          ...
          --Entry 'ack_data': '<S9>:2174'
          scl_reg_next <= '0';
          sda_reg_next <= '1';
          ack_reg_next <= '1';
        END IF;
      WHEN IN_cmd_reg_read_data_n =>
        --During 'cmd_reg_read_data_n': '<S9>:2175'
        --Transition: '<S9>:2237'
        is_i2c_mstr_next <= IN_cmd_reg_read_data_p;
        --Entry 'cmd_reg_read_data_p': '<S9>:2179'
        scl_reg_next <= '1';
        IF sda_in = '1' THEN 
      ...
      WHEN IN_cmd_reg_read_data_p =>
        scl_reg_next <= '1';
        --During 'cmd_reg_read_data_p': '<S9>:2179'
        IF bit_cnt > to_unsigned(16#00#, 8) THEN 
          --Transition: '<S9>:2235'
          is_i2c_mstr_next <= IN_cmd_reg_read_data_n;
          --Entry 'cmd_reg_read_data_n': '<S9>:2175'
      ...
      WHEN IN_cmd_slave_addr_n =>
        --During 'cmd_slave_addr_n': '<S9>:2166'
        --Transition: '<S9>:2252'
        is_i2c_mstr_next <= IN_cmd_slave_addr_p;
        --Entry 'cmd_slave_addr_p': '<S9>:2167'
        scl_reg_next <= '1';
      ...
      WHEN IN_cmd_slave_addr_n1 =>
        --During 'cmd_slave_addr_n1': '<S9>:2214'
        --Transition: '<S9>:2250'
        is_i2c_mstr_next <= IN_cmd_slave_addr_p1;
        --Entry 'cmd_slave_addr_p1': '<S9>:2241'
        scl_reg_next <= '1';
      ...
      WHEN IN_cmd_slave_addr_p =>
        scl_reg_next <= '1';
        --During 'cmd_slave_addr_p': '<S9>:2167'
        IF bit_cnt > to_unsigned(16#00#, 8) THEN 
          --Transition: '<S9>:2220'
          is_i2c_mstr_next <= IN_cmd_slave_addr_n;
          --Entry 'cmd_slave_addr_n': '<S9>:2166'
          scl_reg_next <= '0';
        ...
        ELSE 
          ...
          --Entry 'write_n': '<S9>:2181'
          scl_reg_next <= '0';
          sda_reg_next <= '0';
        END IF;
      WHEN IN_cmd_slave_addr_p1 =>
        scl_reg_next <= '1';
        --During 'cmd_slave_addr_p1': '<S9>:2241'
        IF bit_cnt > to_unsigned(16#00#, 8) THEN 
          --Transition: '<S9>:2201'
          is_i2c_mstr_next <= IN_cmd_slave_addr_n1;
          --Entry 'cmd_slave_addr_n1': '<S9>:2214'
          scl_reg_next <= '0';
        ...
        ELSE 
          ...
          --Entry 'read_n': '<S9>:2228'
          scl_reg_next <= '0';
          sda_reg_next <= '1';
        END IF;
      WHEN IN_delay =>
        --During 'delay': '<S9>:2180'
        --Transition: '<S9>:2293'
        is_i2c_mstr_next <= IN_ready_repeated;
        --Entry 'ready_repeated': '<S9>:2189'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
      WHEN IN_error_ack =>
        n_ack_reg_next <= '1';
        --During 'error_ack': '<S9>:2171'
        --Transition: '<S9>:2196'
        is_i2c_mstr_next <= IN_scl_ext_n;
        --Entry 'scl_ext_n': '<S9>:2163'
        scl_reg_next <= '0';
      ...
      WHEN IN_mastr_ack_data =>
        scl_reg_next <= '0';
        mstr_ack_reg_next <= '1';
        --During 'mastr_ack_data': '<S9>:2168'
        IF mode = '1' THEN 
          --Transition: '<S9>:2224'
          is_i2c_mstr_next <= IN_mastr_ack_data_cnf;
          --Entry 'mastr_ack_data_cnf': '<S9>:2165'
          scl_reg_next <= '1';
          sda_reg_next <= '0';
          mstr_ack_reg_next <= '1';
        ELSE 
          ...
          --Entry 'mastr_ack_data_cnf1': '<S9>:2281'
          scl_reg_next <= '1';
          sda_reg_next <= '1';
          mstr_ack_reg_next <= '1';
        END IF;
      WHEN IN_mastr_ack_data_cnf =>
        --During 'mastr_ack_data_cnf': '<S9>:2165'
        --Transition: '<S9>:2211'
        is_i2c_mstr_next <= IN_Increment_Byte_count1;
        --Entry 'Increment_Byte_count1': '<S9>:2187'
        scl_reg_next <= '0';
        bit_cnt_next <= to_unsigned(16#08#, 8);
        mstr_ack_reg_next <= '0';
      ...
      WHEN IN_mastr_ack_data_cnf1 =>
        --During 'mastr_ack_data_cnf1': '<S9>:2281'
        --Transition: '<S9>:2282'
        is_i2c_mstr_next <= IN_scl_ext_n;
        --Entry 'scl_ext_n': '<S9>:2163'
        scl_reg_next <= '0';
        ...
        mstr_ack_reg_next <= '0';
      WHEN IN_read_n =>
        --During 'read_n': '<S9>:2228'
        --Transition: '<S9>:2202'
        is_i2c_mstr_next <= IN_read_p;
        --Entry 'read_p': '<S9>:2191'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        bit_cnt_next <= to_unsigned(16#08#, 8);
      WHEN IN_read_p =>
        --During 'read_p': '<S9>:2191'
        --Transition: '<S9>:2204'
        is_i2c_mstr_next <= IN_ack_slv1;
        --Entry 'ack_slv1': '<S9>:2219'
        scl_reg_next <= '0';
        ack_reg_next <= '1';
        sda_reg_next <= '1';
      WHEN IN_ready =>
        --During 'ready': '<S9>:2156'
        --Transition: '<S9>:2290'
        is_i2c_mstr_next <= IN_start_n;
        --Entry 'start_n': '<S9>:2159'
        scl_reg_next <= '1';
        sda_reg_next <= '0';
      ...
      WHEN IN_ready_repeated =>
        --During 'ready_repeated': '<S9>:2189'
        --Transition: '<S9>:2245'
        is_i2c_mstr_next <= IN_ready_repeated_dummy;
        --Entry 'ready_repeated_dummy': '<S9>:2233'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
      WHEN IN_ready_repeated_dummy =>
        --During 'ready_repeated_dummy': '<S9>:2233'
        --Transition: '<S9>:2200'
        is_i2c_mstr_next <= IN_repeat_strt_n;
        --Entry 'repeat_strt_n': '<S9>:2182'
        scl_reg_next <= '1';
        sda_reg_next <= '0';
        bit_cnt_next <= to_unsigned(16#07#, 8);
        busy_reg_next <= '1';
      WHEN IN_repeat_strt_n =>
        scl_reg_next <= '1';
        busy_reg_next <= '1';
        --During 'repeat_strt_n': '<S9>:2182'
        --Transition: '<S9>:2249'
        is_i2c_mstr_next <= IN_repeat_strt_p;
        --Entry 'repeat_strt_p': '<S9>:2184'
        sda_reg_next <= '0';
      WHEN IN_repeat_strt_p =>
        --During 'repeat_strt_p': '<S9>:2184'
        --Transition: '<S9>:2248'
        is_i2c_mstr_next <= IN_cmd_slave_addr_n1;
        --Entry 'cmd_slave_addr_n1': '<S9>:2214'
        scl_reg_next <= '0';
      ...
      WHEN IN_scl_ext_n =>
        mstr_ack_reg_next <= '0';
        --During 'scl_ext_n': '<S9>:2163'
        --Transition: '<S9>:2229'
        is_i2c_mstr_next <= IN_scl_ext_p;
        --Entry 'scl_ext_p': '<S9>:2157'
        scl_reg_next <= '1';
        sda_reg_next <= '0';
        ack_reg_next <= '0';
      WHEN IN_scl_ext_p =>
        scl_reg_next <= '1';
        --During 'scl_ext_p': '<S9>:2157'
        --Transition: '<S9>:2209'
      ...
      WHEN IN_start_n =>
        scl_reg_next <= '1';
        busy_reg_next <= '1';
        --During 'start_n': '<S9>:2159'
        --Transition: '<S9>:2210'
        is_i2c_mstr_next <= IN_start_p;
        --Entry 'start_p': '<S9>:2164'
        sda_reg_next <= '0';
      WHEN IN_start_p =>
        --During 'start_p': '<S9>:2164'
        --Transition: '<S9>:2291'
        is_i2c_mstr_next <= IN_cmd_slave_addr_n;
        --Entry 'cmd_slave_addr_n': '<S9>:2166'
        scl_reg_next <= '0';
      ...
      WHEN IN_stop =>
        ...
        --Entry 'stop_ext': '<S9>:2162'
        scl_reg_next <= '1';
        sda_reg_next <= '1';
        ack_reg_next <= '0';
      WHEN IN_stop_ext =>
        --During 'stop_ext': '<S9>:2162'
        --Transition: '<S9>:2215'
        ...
        temp_data_next <= to_unsigned(16#00#, 8);
      WHEN IN_write_n =>
        --During 'write_n': '<S9>:2181'
        --Transition: '<S9>:2225'
        is_i2c_mstr_next <= IN_write_p;
        --Entry 'write_p': '<S9>:2185'
        scl_reg_next <= '1';
        sda_reg_next <= '0';
      WHEN OTHERS => 
        --During 'write_p': '<S9>:2185'
        --Transition: '<S9>:2218'
        is_i2c_mstr_next <= IN_ack_slv;
        --Entry 'ack_slv': '<S9>:2170'
        scl_reg_next <= '0';
        ack_reg_next <= '1';
        sda_reg_next <= '1';
    END CASE;
