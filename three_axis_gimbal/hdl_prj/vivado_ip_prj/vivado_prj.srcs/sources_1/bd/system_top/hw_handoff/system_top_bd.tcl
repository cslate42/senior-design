...
proc create_root_design { parentCell } {
  ...
  set ADXL345_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ADXL345_ip:1.0 ADXL345_ip_0 ]
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins ADXL345_ip_0/AXI4_Lite] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x400D0000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ADXL345_ip_0/AXI4_Lite/reg0] SEG_ADXL345_ip_0_reg0
