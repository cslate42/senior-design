-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mpu6050\ADXL345_ip_src_I2C_MPU6050_IP.vhd
...
-- Source Path: mpu6050/I2C_MPU6050_IP
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ADXL345_ip_src_I2C_MPU6050_IP IS
  ...
  COMPONENT ADXL345_ip_src_MATLAB_Function
  ...
  FOR ALL : ADXL345_ip_src_MATLAB_Function
    USE ENTITY work.ADXL345_ip_src_MATLAB_Function(rtl);
  ...
  SIGNAL tmpConfig                        : std_logic;
  SIGNAL tmpCheckCng                      : std_logic;
  SIGNAL tmpReadGyro                      : std_logic;
  SIGNAL tmpReadAccel                     : std_logic;
  SIGNAL tmpValid                         : std_logic;
  SIGNAL tmpReadDevice                    : std_logic;
  SIGNAL tmpHere                          : std_logic;
  SIGNAL tmpData                          : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL ChipSelect_I2C_out1              : std_logic;
  SIGNAL Addr_Alt_out1                    : std_logic;
  SIGNAL trigUpdate                       : std_logic;
  SIGNAL Unit_Delay_out1                  : std_logic;
  SIGNAL ledArr                           : std_logic_vector(0 TO 7);  -- boolean [8]
  SIGNAL Unit_Delay1_out1                 : std_logic_vector(0 TO 7);  -- boolean [8]
...
BEGIN
  ...
  u_MPU6050_Interface : ADXL345_ip_src_MPU6050_Interface
    PORT MAP( clk => clk,
              ...
              tmp => tmp,
              tmpConfig => tmpConfig,
              tmpCheckCng => tmpCheckCng,
              tmpReadGyro => tmpReadGyro,
              tmpReadAccel => tmpReadAccel,
              tmpValid => tmpValid,
              tmpReadDevice => tmpReadDevice,
              tmpHere => tmpHere,
              tmpData => tmpData  -- uint8
              );
  ...
  -- <S1>/MATLAB Function
  u_MATLAB_Function : ADXL345_ip_src_MATLAB_Function
    PORT MAP( oldLedArr => Unit_Delay1_out1,  -- boolean [8]
              oldTrigUpdate => Unit_Delay_out1,
              tmp => tmp,
              config => tmpConfig,
              checkConfig => tmpCheckCng,
              readGyro => tmpReadGyro,
              readAccel => tmpReadAccel,
              valid => tmpValid,
              readDevice => tmpReadDevice,
              tmpHere => tmpHere,
              dataRead => tmpData,  -- uint8
              update => updateSw0,
              modeSw1 => modeSw1,
              ledArr => ledArr,  -- boolean [8]
              trigUpdate => trigUpdate
              );
