-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mpu6050\I2C_MPU60_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: I2C_MPU60_ip_dut
-- Source Path: I2C_MPU60_ip/I2C_MPU60_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END I2C_MPU60_ip_dut;


ARCHITECTURE rtl OF I2C_MPU60_ip_dut IS

  -- Component Declarations
  COMPONENT I2C_MPU60_ip_src_I2C_MPU6050_IP
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : I2C_MPU60_ip_src_I2C_MPU6050_IP
    USE ENTITY work.I2C_MPU60_ip_src_I2C_MPU6050_IP(rtl);
...
BEGIN
  u_I2C_MPU60_ip_src_I2C_MPU6050_IP : I2C_MPU60_ip_src_I2C_MPU6050_IP
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
