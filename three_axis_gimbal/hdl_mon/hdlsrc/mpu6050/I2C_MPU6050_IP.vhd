-- -------------------------------------------------------------
-- 
-- File Name: hdl_mon\hdlsrc\mpu6050\I2C_MPU6050_IP.vhd
...
ARCHITECTURE rtl OF I2C_MPU6050_IP IS

  -- Component Declarations
  COMPONENT I2C_MPU6050_IP_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT I2C_MasterController
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          enb_1                           :   IN    std_logic;
  ...
  FOR ALL : I2C_MPU6050_IP_tc
    USE ENTITY work.I2C_MPU6050_IP_tc(rtl);

  FOR ALL : MPU6050_Interface
    USE ENTITY work.MPU6050_Interface(rtl);

  FOR ALL : I2C_MasterController
    USE ENTITY work.I2C_MasterController(rtl);
...
BEGIN
  u_I2C_MPU6050_IP_tc : I2C_MPU6050_IP_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MPU6050_Interface : MPU6050_Interface
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              busy => busy,
  ...
  u_I2C_MasterController : I2C_MasterController
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              enb_1 => enb_1,
